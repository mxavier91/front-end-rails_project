...
var config = {
  apiOrigins: {
    production: 'https://railsmovieapp.herokuapp.com/',
...
var onCreate = function onCreate(event) {
  event.preventDefault();
  var data = getFormFields(event.target);
  api.createMovie(data).then(ui.createSuccessful).catch(ui.createFailed);
};

var onShowAll = function onShowAll(event) {
  event.preventDefault();
  api.showAllMovies().then(ui.showAllMoviesSuccess);
...
var onUpdateMovie = function onUpdateMovie(event) {
  event.preventDefault();
  var data = getFormFields(event.target);
  api.updateMovie(data).then(ui.updateSuccess).catch(ui.updateFailed);
};
/*
...
var onDeleteMovie = function onDeleteMovie(event) {
  ...
  api.deleteMovie(id).then(ui.deleteSuccessful).then(function () {
    return onShowAll(event);
  }).catch(ui.deleteFailed);
};

var onShowAllUsers = function onShowAllUsers(event) {
  event.preventDefault();
  var data = getFormFields(event.target);
  api.getAllUsers(data).then(ui.allUsersSuccess).catch(ui.allUserFailure);
  $('#moreContent').toggle();
};

var onAddMovie = function onAddMovie(event) {
  console.log(event.target);
  event.preventDefault();
  var data = { movie: { title: event.target.dataset.title, director: event.target.dataset.director, actor: event.target.dataset.actor } };
  console.log(event.target.dataset);
  api.addMovie(data).then(ui.joinSuccessful)
  // .then(() => onCreate(event))
  .catch(ui.joinFailed);
};

var onShowAllUsersMovies = function onShowAllUsersMovies(event) {
  event.preventDefault();
  var data = event.target.dataset.id;
  api.getAllMovies(data).then(ui.allMoviesSuccess).catch(ui.allMoviesFailure);
  console.log(data);
  $('#moreContent').toggle();
};
...
var getAllUsers = function getAllUsers(data) {
  console.log(data);
  return $.ajax({
...
var getAllMovies = function getAllMovies(data) {
  console.log(data);
  return $.ajax({
    url: config.apiOrigin + '/users',
    method: 'GET',
...
var store = __webpack_require__(5);
var showMovies = __webpack_require__(17);
var showUsersMovies = __webpack_require__(34);
...
var showAllMoviesSuccess = function showAllMoviesSuccess(data) {
  var showMoviesHtml = showMovies({ movies: data.movies });
  $('.content').html(showMoviesHtml);
};

var allUsersSuccess = function allUsersSuccess(data) {
  console.log(data);
  var showUsersMoviesHtml = showUsersMovies({ users: data.users });
  $('#message').text('"It\'s Alive, It\'s Alive!!!"-New Movie Added');
  $('#message').css('background-color', 'green');
...
var deleteSuccessful = function deleteSuccessful() {
...
var joinSuccessful = function joinSuccessful(data) {
  console.log(data);
  $('#message').text('"It\'s Alive, It\'s Alive!!!"-New Movie Added');
  $('#message').css('background-color', 'green');
  store.movie = data.movie;
...
var joinFailed = function joinFailed(error) {
  console.log(error);
  $('#message').text('"Argo F@%# Yourself"-Error Adding Movie');
  $('#message').css('background-color', 'red');
};
...
module.exports = {
  ...
  showAllMoviesSuccess: showAllMoviesSuccess,
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "\n<ul>\n  <h1 data-id=\""
    ...
    + "<br>\n    <button class=\"movie-delete\" data-id="
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + ">\n      Remove\n    </button>\n</ul>\n\n";
},"2":function(container,depth0,helpers,partials,data,blockParams) {
    var stack1, alias1=container.lambda, alias2=container.escapeExpression;

  return "      <li class=\"id\">Movie ID:"
    + alias2(alias1(((stack1 = blockParams[1][0]) != null ? stack1.id : stack1), depth0))
    + "</li>\n      <li class=\"director\">Director:"
    + alias2(alias1(((stack1 = blockParams[1][0]) != null ? stack1.director : stack1), depth0))
    + "</li>\n      <li class=\"actor\">Actor:"
    + alias2(alias1(((stack1 = blockParams[1][0]) != null ? stack1.actor : stack1), depth0))
    + "</li>\n";
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "\n"
    + ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.movies : depth0),{"name":"each","hash":{},"fn":container.program(2, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "");
},"2":function(container,depth0,helpers,partials,data,blockParams) {
    var stack1, alias1=container.lambda, alias2=container.escapeExpression;

  return "\n<h1 data-id=\""
    + alias2(alias1(((stack1 = blockParams[1][0]) != null ? stack1.id : stack1), depth0))
    + "\">\n  <small>\n    <button type=\"button\" class=\"link\">User: "
    + alias2(alias1(((stack1 = blockParams[1][0]) != null ? stack1.email : stack1), depth0))
    + "</button>\n  </small>\n</h1>\n\n<ul>\n"
    + ((stack1 = helpers["if"].call(depth0 != null ? depth0 : (container.nullContext || {}),((stack1 = blockParams[1][0]) != null ? stack1.movies : stack1),{"name":"if","hash":{},"fn":container.program(3, data, 0, blockParams),"inverse":container.program(5, data, 0, blockParams),"data":data,"blockParams":blockParams})) != null ? stack1 : "")
    + "<br>\n</ul>\n<button class=\"add-movie\" data-actor=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.actor : stack1), depth0))
    + "\" data-director=\""
